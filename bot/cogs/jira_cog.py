...
class JiraCog(commands.Cog):
    ...
    # @issue.command(name='mark-done', description='Change the status of an issue to Done.')
    # @guild_only()
    # async def jira_issue_done(self, ctx: discord.ApplicationContext, issue_id=''):
    ...
    #                 title='Success',
    #                 description=f'{issue_id}\'s status has been changed to Done.'))
